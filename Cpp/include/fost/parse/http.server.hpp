...
namespace fostlib {
    ...
    namespace http {
        ...
        struct request_status {
            ...
            enum version_n { http_9 = 9, http_10 = 10, http_11 = 11 } version = http_9;
            url::query_string query;
        };


        template<typename Iterator>
        struct server_first_line : boost::spirit::qi::grammar<Iterator, request_status()> {
            ...
            : server_first_line::base_type(top) {
                ...
                top = (method >> spaces
                        ...
                        >> -(spaces >> version))
                    [boost::phoenix::bind([](auto &l, auto m, auto f, auto qs, auto v) {
                            l = request_status{m, f, v.value_or(request_status::http_9)};
